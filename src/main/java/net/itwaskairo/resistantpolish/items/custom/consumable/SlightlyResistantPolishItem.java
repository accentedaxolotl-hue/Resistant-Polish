...
public class SlightlyResistantPolishItem extends PolishItemBase {
    public SlightlyResistantPolishItem(Properties properties) { super(properties); }
    ...
    protected int getResistanceValue() {
        return ResistantPolishConfig.COMMON.slightPolishValue.get();
    }
}