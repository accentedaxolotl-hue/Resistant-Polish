...
public class VeryResistantPolishItem extends PolishItemBase {
    public VeryResistantPolishItem(Properties properties) { super(properties); }
    ...
    protected int getResistanceValue() {
        return ResistantPolishConfig.COMMON.veryPolishValue.get();
    }
}